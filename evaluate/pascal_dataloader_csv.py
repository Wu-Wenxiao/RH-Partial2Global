...
class                                                                                                                                                     DatasetPASCAL(Dataset):
    ...
    def get_top50_images_val(self):
        ...
        # path = "./dataset/VOC2012/features_vit-laion2b-in21k_val/folder0_top50-similarity.json"
        # path = "./annotation_xu/folder{}_top50-similarity.json".format(self.fold)
        path = "./topk_json_add/folder{}_top50-similarity_add_kl_0.15.json".format(self.fold)
        print(path)
    ...
    def __getitem__(self, idx):
        ...
        # for sim_idx in self.iou_dict[str(idx)]:
            # sim_idx = int(sim_idx)
        support_name_all = []
        for sim_idx in range(50): # 第二个evaluation需要改成1 default
            ...
            support_name_all.append(support_name)
