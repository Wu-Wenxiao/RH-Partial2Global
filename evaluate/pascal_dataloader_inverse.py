...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, split, image_transform, mask_transform, padding: bool = 1, use_original_imgsize: bool = False, flipped_order: bool = False,
        ...
        print(len(self.images_top50_val))
    ...
    def get_top50_images_val(self):
        ...
        # with open(f"./save/valsubsubsub_speed_cp3_0.9_rd20_test_bsz32_ori_filter_result_sourcefold3_fold3_rank5_dinov2_hodge_1_hodge_repro_2e-4_8bs.json") as f:
        ...
        with open(f"./dataset/VOC2012/{self.feature_name}/folder{self.fold}_all-similarity.json") as f:
    ...
    def __getitem__(self, idx):
        ...
        # for sim_idx in self.iou_dict[str(idx)]:
            # sim_idx = int(sim_idx)
        for sim_idx in range(len(self.images_top50_val)): # 第二个evaluation需要改成1 default
            # print(sim_idx)
    ...
    def sample_episode(self, idx, sim_idx):
        ...
        if self.cluster:
            support_name, class_sample, cluster_sample = self.img_metadata_val[idx]
        else:
            support_name, class_sample = self.img_metadata_val[idx]
        ...
        query_name = self.images_top50_val[support_name]['top50'][sim_idx]
