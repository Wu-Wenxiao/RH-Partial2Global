...
def inference_image_return(model, device, img_path, img2_paths, tgt2_paths):
    res, hres = 448, 448
    ...
    # output_final = input_image * (0.6 * output / 255 + 0.4)
    # output_image = Image.fromarray((input_image * (0.6 * output / 255 + 0.4)).astype(np.uint8))
    # output_image.save("./1.jpg")
    # Image.fromarray((output).astype(np.uint8)).save("./2.jpg")
    # breakpoint()
    # return output_final
    return output
