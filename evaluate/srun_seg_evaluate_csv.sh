...
do
    ...
    do
        ...
        python evaluate/evaluate_segmentation_csv.py --model mae_vit_large_patch16 --base_dir /inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/wuwenxiao-240114050176/ranking_in_context-master/dataset --feature_name ${feature_name} --output_dir ablation/${output_name}_folder${folderid}_seed${seed} --ckpt ./checkpoint-1000.pth --fold ${folderid} --seed ${seed} \
