...
do
    ...
    do
        ...
        python evaluate/evaluate_segmentation_all_iou.py --model mae_vit_large_patch16 --base_dir ./dataset --feature_name ${feature_name} --output_dir output_seg_images/all_${output_name}_folder${folderid}_seed${seed} --ckpt ./checkpoint-1000.pth --fold ${folderid} --seed ${seed} \
