...
# alpha = 0.2
        ...
        topk = None
        if fold == 'det':
            annotation_path = "./output_seg_images_ranking/output_vit-laion2b_trn-in21k_det-all_folder0_seed0/annotation-all-det.json"
            sim_path = "./annotation_xu/det_feature/train-all-similarity_map_wwx.json"
        ...
        # print(kl_set)
        w = open("./topall_json/det_kl_set_fold_{}_{}_sum1.json".format(fold, alpha), "w")
